...
const ACTION_BADGE: Partial<Record<ActivityAction, string>> = {
  ...
  TICKET_STUDENT_SUBMIT: 'badge-info',
  TICKET_STUDENT_UPDATE: 'badge-info',
  TICKET_STUDENT_WITHDRAW: 'badge-gray',
  TICKET_APPROVE: 'badge-success',
  TICKET_REJECT: 'badge-danger',
