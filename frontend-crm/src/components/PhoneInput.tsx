...
export const COUNTRIES: Country[] = [
  ...
  { cc: 'kz', code: '+7',   label: 'Казахстан',   minDigits: 9, maxDigits: 9 },
  { cc: 'uz', code: '+998', label: 'Узбекистан',  minDigits: 9, maxDigits: 9 },
  { cc: 'kg', code: '+996', label: 'Кыргызстан',  minDigits: 9, maxDigits: 9 },
  { cc: 'cn', code: '+86',  label: 'Китай',       minDigits: 9, maxDigits: 9 },
  { cc: 'tm', code: '+993', label: 'Туркменистан',minDigits: 9, maxDigits: 9 },
  { cc: 'af', code: '+93',  label: 'Афганистан',  minDigits: 9, maxDigits: 9 },
  { cc: 'tr', code: '+90',  label: 'Турция',      minDigits: 9, maxDigits: 9 },
  { cc: 'ae', code: '+971', label: 'ОАЭ',         minDigits: 9, maxDigits: 9 },
  { cc: 'sa', code: '+966', label: 'Саудовская Аравия', minDigits: 9, maxDigits: 9 },
  { cc: 'ir', code: '+98',  label: 'Иран',        minDigits: 9, maxDigits: 9 },
  { cc: 'in', code: '+91',  label: 'Индия',       minDigits: 9, maxDigits: 9 },
  { cc: 'pk', code: '+92',  label: 'Пакистан',    minDigits: 9, maxDigits: 9 },
  { cc: 'bd', code: '+880', label: 'Бангладеш',   minDigits: 9, maxDigits: 9 },
  { cc: 'us', code: '+1',   label: 'США',         minDigits: 9, maxDigits: 9 },
  { cc: 'gb', code: '+44',  label: 'Великобритания', minDigits: 9, maxDigits: 9 },
  { cc: 'de', code: '+49',  label: 'Германия',    minDigits: 9, maxDigits: 9 },
  { cc: 'fr', code: '+33',  label: 'Франция',     minDigits: 9, maxDigits: 9 },
  { cc: 'it', code: '+39',  label: 'Италия',      minDigits: 9, maxDigits: 9 },
  { cc: 'es', code: '+34',  label: 'Испания',     minDigits: 9, maxDigits: 9 },
  { cc: 'kr', code: '+82',  label: 'Южная Корея', minDigits: 9, maxDigits: 9 },
  { cc: 'jp', code: '+81',  label: 'Япония',      minDigits: 9, maxDigits: 9 },
  { cc: 'th', code: '+66',  label: 'Таиланд',     minDigits: 9, maxDigits: 9 },
  { cc: 'vn', code: '+84',  label: 'Вьетнам',     minDigits: 9, maxDigits: 9 },
  { cc: 'my', code: '+60',  label: 'Малайзия',    minDigits: 9, maxDigits: 9 },
  { cc: 'id', code: '+62',  label: 'Индонезия',   minDigits: 9, maxDigits: 9 },
  { cc: 'mn', code: '+976', label: 'Монголия',    minDigits: 9, maxDigits: 9 },
  { cc: 'az', code: '+994', label: 'Азербайджан', minDigits: 9, maxDigits: 9 },
  { cc: 'am', code: '+374', label: 'Армения',     minDigits: 9, maxDigits: 9 },
  { cc: 'ge', code: '+995', label: 'Грузия',      minDigits: 9, maxDigits: 9 },
  { cc: 'by', code: '+375', label: 'Беларусь',    minDigits: 9, maxDigits: 9 },
  { cc: 'ua', code: '+380', label: 'Украина',     minDigits: 9, maxDigits: 9 },
  { cc: 'eg', code: '+20',  label: 'Египет',      minDigits: 9, maxDigits: 9 },
];
