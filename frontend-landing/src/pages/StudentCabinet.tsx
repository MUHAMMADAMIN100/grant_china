...
const REQUIRED_DOCS = [
  ...
  // 12.08.2026 — приглашение из университета: студент его НЕ загружает,
  // а получает от менеджера. Плитка нужна, чтобы он видел готовность и мог
  // скачать файл для посольства.
  { type: 'INVITATION', label: 'Приглашение из университета', hint: 'Загружает менеджер — понадобится для визы' },
];
